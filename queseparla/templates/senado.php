<?php include_once 'header.php'; ?>
	...
	<script>
		window.onload=function(){
			...
			$.getJSON("//tedic.org/queseparla/agenda/senado/proximos/json/",function(datos){
				var html=template(datos);
				$('#ahora').html(html);
				console.info('LISTO');
			});

			$.getJSON("//tedic.org/queseparla/agenda/senado/ultimos/json/",function(datos){
				var html=template(datos);
