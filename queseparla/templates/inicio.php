<?php include_once 'header.php'; ?>
	...
	<script>
		window.onload=function(){
			...
			$.getJSON("http://tedic.org/queseparla/proximos/json",function(datos){
				var html=template(datos);
				$('#ahora').html(html);
				console.info('LISTO');
			});

			$.getJSON("http://tedic.org/queseparla/ultimomes/json",function(datos){
				var html=template(datos);
